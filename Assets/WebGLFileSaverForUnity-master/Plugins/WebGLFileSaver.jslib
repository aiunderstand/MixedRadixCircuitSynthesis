...
mergeInto(LibraryManager.library, {
	...
	{
		var decoded = window.atob(Pointer_stringify(content));		
		var blob = new Blob([decoded], {type: Pointer_stringify(mimetype)});		
		saveAs(blob, Pointer_stringify(name));
		
		var blob2 = new Blob([Pointer_stringify(content)], {type: Pointer_stringify(mimetype)});		
		saveAs(blob2, Pointer_stringify(name));
	},
